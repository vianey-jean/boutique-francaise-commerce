...
const RegisterPage = () => {
  ...
  const loadRegisterData = async () => {
    // Simuler le chargement des données d'inscription
  ...
  return (
    <Layout>
      <PageDataLoader
        fetchFunction={loadRegisterData}
        onSuccess={handleDataSuccess}
        onMaxRetriesReached={handleMaxRetriesReached}
        loadingMessage="Chargement de la page d'inscription..."
        loadingSubmessage="Préparation de votre nouveau compte..."
        errorMessage="Erreur de chargement de l'inscription"
      >
